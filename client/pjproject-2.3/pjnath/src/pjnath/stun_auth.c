				      ...
				      const pj_stun_auth_cred *src)
{
	...
	pj_strdup_with_null(pool, &dst->data.static_cred.realm,
			&src->data.static_cred.realm);
	pj_strdup_with_null(pool, &dst->data.static_cred.username,
			&src->data.static_cred.username);
	dst->data.static_cred.data_type = src->data.static_cred.data_type;
	pj_strdup_with_null(pool, &dst->data.static_cred.data,
			&src->data.static_cred.data);
	pj_strdup_with_null(pool, &dst->data.static_cred.nonce,
