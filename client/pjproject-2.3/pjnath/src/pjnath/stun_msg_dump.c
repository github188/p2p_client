		      ...
		      const pj_stun_attr_hdr *ahdr)
{
	...
	case PJ_STUN_ATTR_P2P_ASSIST: /*add for p2p*/
	case PJ_STUN_ATTR_P2P_CONN_ID: /*add for p2p*/
	case PJ_STUN_ATTR_P2P_INITIATIVE:/*add for p2p*/
	case PJ_STUN_ATTR_P2P_CONN_TIME:
	case PJ_STUN_ATTR_P2P_CONN_RESULT:
	case PJ_STUN_ATTR_P2P_TRANSMIT_COUNT:
	case PJ_STUN_ATTR_P2P_TYPE:
	{
	    const pj_stun_uint_attr *attr;
	...
	case PJ_STUN_ATTR_P2P_LOCAL_USER: //add for p2p
	case PJ_STUN_ATTR_P2P_LOCAL_INFO:	case PJ_STUN_ATTR_P2P_REMOTE_INFO:
	case PJ_STUN_ATTR_P2P_REMOTE_USER:
	case PJ_STUN_ATTR_P2P_GUID:
	{
