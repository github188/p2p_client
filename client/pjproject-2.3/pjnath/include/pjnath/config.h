...
#   define PJ_STUN_MAX_TRANSMIT_COUNT		    7 //modify for p2p,more try send stun message
#endif
...
#   define PJ_STUN_KEEP_ALIVE_SEC		    25 //modify by p2p, old value is 15
#endif
...
#   define PJ_TURN_KEEP_ALIVE_SEC		    25 //modify by p2p, old value is 15
#endif
...
#   define PJNATH_MAKE_SW_NAME(a,b,c,d)     "p2pc____pjnath-" #a "." #b "." #c d  /*modify for p2p,old value no 'p2pc____'*/
