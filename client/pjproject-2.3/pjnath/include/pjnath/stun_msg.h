...
typedef enum pj_stun_msg_type
{
	...
	//add for p2p
	/**
     * STUN p2p connect request.
     */
    PJ_STUN_P2P_CONNNECT_REQUEST		    = 0x1001,

    /**
     * Successful response to STUN p2p connect request.
     */
   PJ_STUN_P2P_CONNNECT_RESPONSE		    = 0x1101,

    /**
     * Error response to STUN p2p connect request.
     */
    PJ_STUN_P2P_CONNNECT_ERROR_RESPONSE	    = 0x1111,

	/**
     * STUN p2p exchange information request.
     */
    PJ_STUN_P2P_EXCHANGE_INFO_REQUEST		  = 0x1002,

    /**
     * Successful response to STUN exchange information request.
     */
   PJ_STUN_P2P_EXCHANGE_INFO_RESPONSE		  = 0x1102,

    /**
     * Error response to STUN exchange information request.
     */
    PJ_STUN_P2P_EXCHANGE_INFO_ERROR_RESPONSE   = 0x1112,

	/**
     * STUN p2p disconnect request.
     */
    PJ_STUN_P2P_DISCONNNECT_REQUEST		    = 0x1003,

	/**
     * STUN p2p close relayed socket
     */
    PJ_STUN_P2P_CLOSE_RELAYED_SOCKET	    = 0x1004,

	PJ_STUN_P2P_CLOSE_RELAYED_SOCKET_RESPONSE = 0x1104,

	/**
     * STUN p2p report session information
     */
    PJ_STUN_P2P_REPORT_SESSION_INFO	    = 0x1005,

	PJ_STUN_P2P_REPORT_SESSION_INFO_RESPONSE = 0x1105,
...
typedef enum pj_stun_attr_type
{
	...
	/*add for p2p*/
	PJ_STUN_ATTR_P2P_ASSIST		= 0x0031,
	PJ_STUN_ATTR_P2P_LOCAL_USER	= 0x0032, 
	PJ_STUN_ATTR_P2P_REMOTE_USER= 0x0033, 
	PJ_STUN_ATTR_P2P_CONN_ID	= 0x0034, 
	PJ_STUN_ATTR_P2P_INITIATIVE	= 0x0035,
	PJ_STUN_ATTR_P2P_LOCAL_INFO	= 0x0036,
	PJ_STUN_ATTR_P2P_REMOTE_INFO= 0x0037,
	PJ_STUN_ATTR_P2P_TYPE		= 0x0038,
	PJ_STUN_ATTR_P2P_GUID		= 0x0039,
	PJ_STUN_ATTR_P2P_CONN_TIME  = 0x003A,
	PJ_STUN_ATTR_P2P_CONN_RESULT  = 0x003B,
	PJ_STUN_ATTR_P2P_TRANSMIT_COUNT  = 0x003C,
