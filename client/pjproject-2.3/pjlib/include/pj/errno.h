 ...
 */
#define PJ_SOCK_PAIR_ERROR   (PJ_ERRNO_START_STATUS + 25)/* 70025 */

/**
 * @hideinitializer
 * failed to udt connect to remote user
 */
#define PJ_UDT_CONNECT_FAILED   (PJ_ERRNO_START_STATUS + 26)/* 70026 */

#define PJ_CACHE_FULL  (PJ_ERRNO_START_STATUS + 27)/* 70027 */
/** @} */   /* pj_errnum */
