...
//add for p2p
PJ_DECL(pj_status_t) pj_activesock_post_read(pj_activesock_t *asock,
											 unsigned buff_size,
											 void *readbuf[],
											 pj_uint32_t flags)
{
					       ...
					       pj_uint32_t flags)
{
	...
	return pj_activesock_post_read(asock, buff_size, readbuf, flags);
}
